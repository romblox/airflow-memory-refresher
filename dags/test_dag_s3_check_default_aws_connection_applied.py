...
@dag(
    dag_id='s3_access_check_on_default_aws_connection_applied',
    description='Check access to S3 bucket on default AWS connection',
    tags=['s3', 'access', 'check'],
)
def s3_access_check_on_default_aws_connection_applied():
    @task
    def start_check():
...
s3_access_check_on_default_aws_connection_applied()
